...
public class ThreadActionDAO extends DAO {
     ...
     */
    public static int addThread(String fromUser, String toUser,
     ...
     */
    public static void addTags(int threadId, List<String> usernames) {
     ...
     */
    public static void deleteThread(int threadId, String username) {
     ...
     */
    public static void replyToThread(int threadId, String username, String content) {
     ...
     */
    public static void toggleLikeThread(int threadId, String username) {
     ...
     * @param username The user liking the thread.
     */
    public static void toggleDislikeThread(int threadId, String username) {
