...
import com.g1t11.socialmagnetservice.model.social.Comment;
...
public class ThreadLoadDAO extends DAO {
     ...
     */
    public static void setCommentsLatestLast(Thread thread, int limit) {
    ...
    public static void setAllCommentsLatestLast(Thread thread) {
     ...
     * @param thread The thread to update.
     */
    public static void setLikers(Thread thread) {
     ...
     * @param thread The thread to update.
     */
    public static void setDislikers(Thread thread) {
     ...
     */
    public static List<String> getTaggedUsernames(int threadId) {
     ...
     */
    public static List<Thread> getNewsFeedThreads(String username, int limit) {
     ...
     */
    public static List<Thread> getWallThreads(String username, int limit) {
